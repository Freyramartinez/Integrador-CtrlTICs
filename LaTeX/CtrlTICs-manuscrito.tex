...
\author{Gonzalez Yañez Dulce Karen}
\affil{Instituto Tecnológico Superior del Occidente del Estado de Hidalgo, Mixquiahuala, Hgo., 42700, Mexico}

\author{Mendoza Calva Marco Antonio}
\affil{Instituto Tecnológico Superior del Occidente del Estado de Hidalgo, Mixquiahuala, Hgo., 42700, Mexico}

\author{Gomez Mejia Eduardo}
\affil{Instituto Tecnológico Superior del Occidente del Estado de Hidalgo, Mixquiahuala, Hgo., 42700, Mexico}
...
\subsection{}
\section{\textbf{\textit{BIOGRAFIAS}}}
\begin{IEEEbiography}{Freyra Wendy Martinez Martinez}{,} tiene 18 años y vive en Tlaxcoapan, Hidalgo. Desde los 14 años ha demostrado interés por resolver problemas relacionados con la tecnología. Su meta a corto plazo es adquirir habilidades de programación sólidas y destacarse como estudiante por sus conocimientos, para así completar su carrera universitaria como ingeniera. En su tiempo libre, le gusta jugar videojuegos y pasar tiempo con su mascota.
